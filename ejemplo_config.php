...
$config['carousel'][0]['contenido'] = '<p>2º Ciclo de Infantil a Bachillerato</p><p style="display: block; padding: 8px; background-color: #eaff00; color: blue; text-align: center;">Plazo de admisión</p><p style="display: block; padding: 8px; background-color: #eaff00; color: blue; text-align: center;">1 de marzo al 1 de abril</p>';
...
$config['carousel'][1]['contenido'] = '<p>Curso 2018/19</p><p><a class="text-white" href="http://www.juntadeandalucia.es/educacion/portals/web/prodig/presentacionesjjii" target="_blank">Ver contenidos de las jornadas iniciales</a></p>';
