...
if (($claveal or $id) and $curso) {
	...
	$ya_alma = mysqli_query($db_con,"select claveal, apellidos, nombre, unidad from alma where curso like '% de E.S.O.%' and (". $conditio1 .")");
