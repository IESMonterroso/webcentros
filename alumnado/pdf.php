...
require_once("../intranet/pdf/dompdf_config.inc.php");
...
function cambia_fecha($fec)
{
	...
	$html.="<h2 align='center'><u>Informe de materias para alumnos con pendientes</u></h2>";
	...
	$materias = mysqli_query($db_con, "SELECT distinct informe_pendientes.asignatura, informe_pendientes.id_informe, informe_pendientes.fecha, informe_pendientes.curso FROM informe_pendientes, informe_pendientes_alumnos WHERE informe_pendientes_alumnos.id_informe = informe_pendientes.id_informe and claveal = '$claveal'");
