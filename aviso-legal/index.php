        ...
        <div class="container">
            ...
            <div class="row justify-content-md-center">
                ...
                <div class="col-md-8">
                    ...
                    <h5>5.4. Cómo ejercer tus derechos</h5>

                    <p>Puedes ejercer tus derechos en relación con el tratamiento de tus datos personales por dos vías:</p>

                    <p>A través de internet: <a href="https://ws094.juntadeandalucia.es/V_virtual/SolicitarTicket?v=PRGPD" target="_blank">Accede a la solicitud online</a> (requiere certificado digital)</p>

                    <p>Presencialmente: <a href="http://www.juntadeandalucia.es/export/drupaljda/002811-A00-V00-00.pdf" target="_blank">Descarga el formulario de solicitud</a>, rellénalo y entrégalo en una <a href="http://www.juntadeandalucia.es/servicios/oficinas-registros-documentos.html" target="_blank">oficina de registro</a>.</p>

                    <p>Adicionalmente puedes presentar una reclamación ante la Agencia Española de Protección de Datos, del modo indicado en la dirección <a href="https://www.aepd.es/" target="_blank">www.aepd.es</a>, en particular si consideras que no has obtenido satisfacción en el ejercicio de tus derechos por el cauce indicado anteriormente.</p>
